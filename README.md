...
2. **Gemini AI Analysis**: Tích hợp Gemini AI (mặc định `gemini-2.5-flash-lite`, có thể đổi bằng biến môi trường `GEMINI_MODEL`) thực hiện phân tích 3-trong-1 chỉ với một lượt gọi API:
...
# Tùy chọn: đổi vị trí lưu dữ liệu cho từng người dùng/máy
FB_JOB_DATA_DIR=./data
FB_COOKIES_PATH=./data/fb_cookies.json
FB_DATABASE_PATH=./data/jobs.db
FB_REPORT_DIR=./reports
FB_CV_PATH=./resume/cv.txt
FB_CV_VI_PATH=./resume/cv_vi.txt

# Tùy chọn: dùng cho scripts/auto_login.py nếu muốn tự điền form login
FB_EMAIL=your_facebook_email
FB_PASSWORD=your_facebook_password
```

### 3. Chuẩn bị Cookies đăng nhập Facebook
Đọc kỹ hướng dẫn tại [docs/export_cookies.md](docs/export_cookies.md). Sau khi export cookies bằng extension, hãy lưu file này tại đường dẫn `data/fb_cookies.json`.
...
- [resume/cv.txt](resume/cv.txt) (Tiếng Anh)
- [resume/cv_vi.txt](resume/cv_vi.txt) (Tiếng Việt)
...
Đọc chi tiết hướng dẫn tại [docs/internet_deploy.md](docs/internet_deploy.md) để biết cách triển khai lên Render hoặc VPS riêng.
